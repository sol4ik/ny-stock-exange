...
## Conclusions
To sum up, we can say that there are not much obvious corellations between the stock data which makes stock prices prediction not a sample task to complete.  
